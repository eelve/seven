<nav class="cover-navigation navigation--social">
    <ul class="navigation">
        ...
        <li class="navigation__item">
            <a href="http://weibo.com/${settings.weibo}" title="微博" target="_blank">
        ...
        <!-- Github -->
        <li class="navigation__item">
            <a href="https://github.com/${settings.github}" title="Github"
               target="_blank">
        ...
        <!-- Twitter -->
        <li class="navigation__item">
            <a href="http://twitter.com/${settings.twitter}" title="Twitter" target="_blank">
